...
//Declaration des fonctions
  void DeuxiemeCoup(int y, int x); //Ligne 478
  bool prenable(int y, int x); //Ligne 24
  void update(int n, int y0, int x0, int y1, int x1); //Ligne 98
  void Jeu(); //Ligne 345
  void PlateauInitiale(int *Damier); //Ligne 523
  void Affiche(int *Damier); //Ligne 585
  bool Victoire(bool player); //Ligne 555
  void AI(); //Ligne 169
